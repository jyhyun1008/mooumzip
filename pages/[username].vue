...
onMounted(()=> {
    ...
    if (`@${username}@${host}` == localStorage.getItem('signinId')) {
        document.querySelector('#linkmap-content').innerHTML += '<div id="linkmap-ui"><div class="map-ui" id="left-ui"><div>🪙: 0000</div></div><div class="map-ui" id="right-ui"><div>상점</div><div>인벤토리</div></div></div>'
    }
